...
function OtoVideo() {
  ...
  const [assessmentType, setAssessmentType] = useState<{
    label: string;
    code: string;
  } | null>({ label: "Oto_Video", code: "Oto_Video" });
  ...
  const handleCreateCognitiveTestOk = async () => {
    ...
    const formData = {
      ...
      assessment_type: assessmentType?.label || "Oto_Video", // Default value for backend
            ...
            >
              ...
              > */}
                <Button
                  ...
                  onClick={() => {
                    setSelectedAssessmentTypeForCreation("oto_video");
          ...
          <Row align="middle" gutter={[8, 8]} className="flex-wrap justify-end">
            ...
            <Col xs={12} sm={8} md={6} lg={4}>
              <CustomSelect
                ...
                options={[
                  { label: "Oto_Video", value: "Oto_Video" }
                ]}
                selectedBg="var(--bg-secondary)"
                onChange={(value: string) => {
                  const selectedOption = { label: "Oto_Video", code: value };
                  setAssessmentType(selectedOption);
                }}
                value={assessmentType?.code || "Oto_Video"}
                disabled={true}
                style={{
                  backgroundColor: "var(--bg-secondary)",
                  color: "var(--text-primary)",
